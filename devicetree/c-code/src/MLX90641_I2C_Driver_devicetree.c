...
#include "i2c.h"
#include "MLX90641_I2C_Driver_devicetree.h"
...
MLX90641_get_register_devicetree(void)
{
  static struct MLX90641DriverRegister_t reg;

  strcpy(reg.name_, "/dev/i2c-");
  reg.MLX90641_get_i2c_handle_  = MLX90641_get_i2c_handle_devicetree;
  reg.MLX90641_set_i2c_handle_  = MLX90641_set_i2c_handle_devicetree;
  reg.MLX90641_I2CInit_         = MLX90641_I2CInit_devicetree;
  reg.MLX90641_I2CClose_        = MLX90641_I2CClose_devicetree;
  reg.MLX90641_I2CRead_         = MLX90641_I2CRead_devicetree;
  reg.MLX90641_I2CFreqSet_      = MLX90641_I2CFreqSet_devicetree;
  reg.MLX90641_I2CGeneralReset_ = MLX90641_I2CGeneralReset_devicetree;
  reg.MLX90641_I2CWrite_        = MLX90641_I2CWrite_devicetree;
  return &reg;
}


void *
MLX90641_get_i2c_handle_devicetree(void)
{
...
void
MLX90641_set_i2c_handle_devicetree(void *handle)
{
  g_handle = (struct i2c_device *)handle;
}


void MLX90641_I2CInit_devicetree(const char *i2cPort) 
{
    if (g_handle == NULL)
    {
